...
import org.emaginalabs.beanproxy.core.controller.proxy.behaviour.NullProxyControllerBehaviourStrategy;
import org.emaginalabs.beanproxy.core.controller.proxy.behaviour.ProxyControllerBehaviourStrategy;
...
public class BeanProxyController extends AbstractBeanProxyController {
    ...
    @PostMapping(value = "/{serviceName}/{methodName}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    protected Object execute(Object service, Method method, Object[] arguments) {
        ...
        result = ReflectionUtils.invokeMethod(method, service, arguments);
