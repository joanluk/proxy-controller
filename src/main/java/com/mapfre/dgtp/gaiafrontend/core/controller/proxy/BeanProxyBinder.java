...
import com.mapfre.dgtp.gaia.commons.util.GaiaClassUtils;
import com.mapfre.dgtp.gaia.core.jackson.map.ObjectMapperFactory;
import com.mapfre.dgtp.gaiafrontend.core.beans.proxy.*;
import com.mapfre.dgtp.gaiafrontend.core.web.bind.annotation.ArgumentsWrapperBean;
import com.mapfre.dgtp.gaiafrontend.core.web.bind.annotation.MultipleArgumentsWrapperBean;
...
public class BeanProxyBinder implements InitializingBean {
    ...
    private void searchArgumentsWrapperBeans() throws ClassNotFoundException, LinkageError {
        ...
        for (MetadataReader metadata : candidateClasses) {
            clazz = (Class<ArgumentsWrapper>) GaiaClassUtils.forName(metadata.getClassMetadata().getClassName(), null);
    ...
    private Class<?> getBindingClass(Method method) {
        ...
        Class<?> declaringClass = GaiaClassUtils.getDeclaringClass(method);
